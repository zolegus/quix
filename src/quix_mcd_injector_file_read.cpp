...
using behaviour_type = behaviour::file_read< event_type >;
using node_type = node::injector< transport_type, behaviour_type >;
//
///////////////////////////////////////////////////////////////////////////////////////////////////
//
int main(
  ...
  )
{
  ...
  transport_type transport(	
    ...
    cfg.get< transport_type::injector_channel_type >( "transport.channel" ),
  ...
  behaviour_type behaviour(
    ...
    cfg.get< std::string >( "behaviour.file.read" )
    );
